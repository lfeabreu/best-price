...
async function fetchData(regiao) {
    ...
    try {
        ...
        console.log(`Geohash para ${regiao}: ${LOCAL_ID}`);
    } catch (err) {
        console.error('Erro ao buscar geohash:', err);

        showToast('Erro ao buscar os dados para a cidade selecionada.', 'danger');
